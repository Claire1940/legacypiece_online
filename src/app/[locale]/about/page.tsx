...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.legacypiece.online'
  const path = '/about'

  return {
    title: 'About Legacy Piece Wiki - Your Ultimate Roblox Game Resource',
    description: 'Learn about Legacy Piece Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Legacy Piece Roblox game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'Legacy Piece Wiki',
      title: 'About Legacy Piece Wiki',
      description: 'Learn about our mission to provide the best Legacy Piece game resources and guides.',
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: 'Legacy Piece Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Legacy Piece Wiki',
      description: 'Learn about our mission to provide the best Legacy Piece game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Legacy Piece Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Legacy Piece
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Legacy Piece Wiki</h2>
            <p>
              Legacy Piece Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Roblox game "Legacy Piece". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Legacy Piece Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Legacy Piece players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Legacy Piece Wiki as the <strong>go-to destination</strong> for every Legacy Piece player seeking
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Legacy Piece Codes</h3>
              <p className="text-slate-300">
                The latest Legacy Piece codes, free rewards, and redemption bonuses all in one place.
                Never miss a new code drop!
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">🍇</div>
              <h3 className="text-xl font-semibold text-white mb-2">Fruits Database</h3>
              <p className="text-slate-300">
                Complete Legacy Piece fruit database with abilities, rarities, and tier rankings.
                Find, compare, and master every fruit.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">⚡</div>
              <h3 className="text-xl font-semibold text-white mb-2">Abilities & Haki</h3>
              <p className="text-slate-300">
                Master every ability, skill, and Haki system. Unlock conditions, combos, and upgrade paths
                for every spec and build.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Boss locations, spawn timers, drop tables, and battle strategies.
                Defeat every boss with proven tactics and loadouts.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Fastest leveling routes, progression paths, and recommended maps.
                Level up efficiently from newbie to pro sailor.
              </p>
            </div>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Legacy Piece Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Legacy Piece Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Legacy Piece as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Legacy Piece mechanics and strategies</li>
            ...
            <p className="text-slate-400 italic text-sm">
              Project Codename: "Grand Piece" – Charting the seas of knowledge together.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Legacy Piece Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@legacypiece.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@legacypiece.online
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@legacypiece.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@legacypiece.online
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@legacypiece.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@legacypiece.online
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@legacypiece.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@legacypiece.online
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Legacy Piece news.
